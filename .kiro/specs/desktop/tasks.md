...
- [x] 4. Build Desktop workspace and context




  - [x] 4.1 Create Desktop root component
  ...
  - [x] 4.2 Implement DesktopWorkspace component
  ...
  - [x] 4.3 Create WindowContext provider
...
- [x] 5. Implement Window Manager core



- [ ] 5. Implement Window Manager core

  - [x] 5.1 Create Window component with Win95 chrome
  ...
  - [x] 5.2 Implement window dragging functionality
  ...
  - [x] 5.3 Implement window focus and z-index management
  ...
  - [x] 5.4 Implement window control operations
  ...
  - [x] 5.5 Add window positioning logic
...
- [x] 6. Build Taskbar component
  ...
  - [x] 6.1 Create Taskbar layout and styling
...
- [x] 7. Create Start Menu component



  - [x] 7.1 Implement Start Menu layout and positioning
  ...
  - [x] 7.4 Implement menu open/close logic
...
- [x] 8. Create application registry and integration
  ...
  - [x] 8.1 Define AppDefinition interface and registry
